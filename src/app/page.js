  ...
  export default function Home() {
    return (
      <div className="min-h-screen bg-gradient-to-r from-green-300 to-green-100 flex flex-col items-center justify-center py-5 px-2">
        <main className="bg-green-100 rounded-lg shadow-md p-3 w-full mx-10 md:max-w-sm lg:max-w-md border-2 border-blue-300 border-opacity-50">
